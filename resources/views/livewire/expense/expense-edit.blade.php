<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <form action="" wire:submit.prevent="updateExpense" class="w-full max-w-7xl mx-auto">
        ...
        <div class="flex flex-wrap -mx-3 mb-6 mt-6">
            ...
            <p class="w-full py-4 px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Foto do Comprovante</label>
                ...
                @error('photo')
                    <h5 class="text-red-500 text-xs italic">{{$message}}</h5>
                @enderror
                <img src="{{route('expenses.photo', $expense->id)}}" alt="" width="150">
            </p>
            <p class="w-full py-4 px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Foto do Comprovante</label>
